 ...
 */
namespace Oceanpayment\FPS\Model;
...
class PaymentMethod extends AbstractMethod
{
    ...
    protected $_formBlockType = 'Oceanpayment\FPS\Block\Form';
    protected $_infoBlockType = 'Oceanpayment\FPS\Block\Info';
    ...
    {
        return $this->urlBuilder->getUrl('oceanpaymentfps/payment/redirect', ['_secure' => true]);
    }
    ...
    public function getCheckoutParameter()
    {
        ...
        //返回地址
        $backUrl           = $this->urlBuilder->getUrl('oceanpaymentfps/payment/back', ['_secure' => true,'_nosid' => true]);
        //服务器响应地址
        $noticeUrl         = $this->urlBuilder->getUrl('oceanpaymentfps/payment/notice', ['_secure' => true,'_nosid' => true]);
        //备注
